...
<script src="js/jquery-2.2.3.min.js"></script>  
  ...
  <body>
  	<div class="wrap">
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="index.html">Customer<span>page</span></a>
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	        <span class="fa fa-bars"></span> Menu
	      </button>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item "><a href="customer_home.jsp" class="nav-link">View Service Plan</a></li>
	        	<li class="nav-item active"><a href="searchsignal_strength.jsp" class="nav-link">Search Signal Strength</a></li>
<!-- 	        	<li class="nav-item"><a href="sviewgraph.jsp" class="nav-link">View Graph</a></li>
	     -->    	<li class="nav-item"><a href="customerview_solution.jsp" class="nav-link">Customer Solution</a></li>
    ...
    <!-- END nav -->
    <div class="hero-wrap js-fullheight" style="background-image: url('images/banner11.jpg');" data-stellar-background-ratio="0.5">
  ...
  <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb">
		...
		<div class="container">
			<h3 style="font-size:45px;text-align:center;">Search Signal Strength</h3> <br>
			<div class="contact-w3lsrow">
				<div class="col-md-6 contact-left wthree">
					<img src="images/images/wifi.jpg" style="width:300px;height:300px;margin-left:70px;">
				</div>
				<div class="col-md-6 contact-right" style="margin-top:50px;">
					<form action="search_locdb.jsp" method="post">
				<select name="location" style="width:400px;height:40px;">	
				<option>Select Location</option>
					<% 
						 try{
			
	     Connection con = databasecon.getconnection();
         PreparedStatement ps=con.prepareStatement("select *  from signal_strength group by location");
  ...
  <!-- 	  <section class="ftco-section ftco-no-pt ftco-no-pb">
			...
			<div class="container">
	            ...
	            <p><a href="#" class="btn btn-secondary">View All Staff</a></p>
					...
					<div class="col-md-4 col-lg-3 ftco-animate d-flex">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
		asddknfjfnfkjfkeienelknen		
		
		
		ehjjjeefnlllfiejeiji
					...
					<div class="col-md-4 col-lg-3 ftco-animate d-flex">
						<div class="staff">
							...
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Lloyd Wilson</h3>gffjjeuehfnfllfuefnkhheiruii
								<span class="position mb-2">Office Cleaner</span>
								<div class="faded">
									<ul class="ftco-social text-center">
		                <li class="ftco-animate"><a href="#" class="d-flex align-items-center justify-content-center"><span class="fa fa-twitter"></span></a></li>
    ...
    <section class="ftco-section testimony-section ftco-bg-dark">
      <div class="container">
        <div class="row justify-content-center pb-5 mb-3">heirutherijjouitjjghhworuurrejoeurjjjryekk
        ...
        <div class="row ftco-animate">
          <div class="col-md-12">khfgjeryuuweyiehjjrugshdgftooiryrhgfieyteiuhfhiduyyffdghiuyrhkkifhgderrrgff
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4">jeurwouoosfoejffufjejsllsfeiofjohhgkwufhwfsjjdjdd
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="" target="_blank">Customerpage</a>
