...
<script src="js/jquery-2.2.3.min.js"></script>  
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item "><a href="ownerhome.jsp" class="nav-link">View ISP</a></li>
	        	<li class="nav-item active"><a href="view_customer.jsp" class="nav-link">View Customer</a></li>
  ...
  <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb">
		...
		<div class="container">
			<h3 style="font-size:45px;text-align:center;">View Customer</h3> <br>
