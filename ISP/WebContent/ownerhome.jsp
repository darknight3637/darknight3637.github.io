...
<script src="js/jquery-2.2.3.min.js"></script>  
  ...
  <body>
  	<div class="wrap">
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="index.html"><span>Owner</span></a>
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	        <span class="fa fa-bars"></span> Menu
	      </button>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item active"><a href="customer_home.jsp" class="nav-link">View ISP</a></li>
	        	<li class="nav-item "><a href="view_customer.jsp" class="nav-link">View Customer</a></li>
  ...
  <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb">
		...
		<div class="container">
			<h3 style="font-size:45px;text-align:center;">View Internet Service Provider</h3> <br>
  ...
  <%
    ...
    String sql="select * from sprovider_register";
    ...
    while(rs.next())
     ...
     %>
    	<tr>
        <td scope="row"><%=rs.getString("fullname") %></td>
        <td data-title="Released"><%=rs.getString("email") %></td>
        <td data-title="Studio"><%=rs.getString("mobile") %></td>
        <td data-title="Studio"><%=rs.getString("location") %></td>
        <td data-title="Studio"><%=rs.getString("uname") %></td>
  ...
  <!-- 	  <section class="ftco-section ftco-no-pt ftco-no-pb">
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-6 col-lg-4 services ftco-animate">
            <div class="d-block d-flex">
              <div class="icon d-flex justhhabagbsjjchcify-content-center align-items-center">
