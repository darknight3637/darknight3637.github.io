	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item active"><a href="customer_home.jsp" class="nav-link">View Service Plan</a></li>
...
<!-- 	        	<li class="nav-item"><a href="sviewgraph.jsp" class="nav-link">View Graph</a></li>
  ...
  <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb">
		...
		<div class="container">
			<h3 style="font-size:45px;text-align:center;">View Internet Service Plan</h3> <br>
  ...
  <%
    ...
    String sql="select * from plan_details";
    ...
    while(rs.next())
     ...
     %>
    	<tr>
        <td scope="row"><%=rs.getString("servicename") %></td>
        <td data-title="Released"><%=rs.getString("plan_name") %></td>
        <td data-title="Studio"><%=rs.getString("signal_strength") %></td>
        <td data-title="Studio"><%=rs.getString("duration") %></td>
        <td data-title="Studio"><%=rs.getString("amount") %></td>
        <td data-title="Studio"><a href="select_plan.jsp?planid=<%=rs.getString("id")%>&&pname=<%=rs.getString("plan_name")%>&&strength=<%=rs.getString("signal_strength")%>&&amount=<%=rs.getString("amount")%>">Select Plan</a></td>
