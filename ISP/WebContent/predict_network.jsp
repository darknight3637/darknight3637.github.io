  ...
  <%
    ...
    while(rs.next())
     ...
     %>
        ...
        <td data-title="Studio"><a href="predict_network1.jsp?loc1=<%=rs.getString("location")%>&&unid=<%=rs.getString("id")%>&&cemail=<%=rs.getString("cemail")%>">Predict the range of network</a></td>
