	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="searchsignal_strength.jsp" class="nav-link">Search Signal Strength</a></li>
<!-- 	        	<li class="nav-item"><a href="sviewgraph.jsp" class="nav-link">View Graph</a></li>
	     -->    	<li class="nav-item active"><a href="customerview_solution.jsp" class="nav-link">Customer Solution</a></li>
  ...
  <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb">
		...
		<div class="container">
			<h3 style="font-size:45px;text-align:center;">View Signal Strength Solution</h3> <br>
  ...
  <tr>
    <th>Customer Name</th>
    <th>Location Name</th>
    <th>Area Signal Strength</th>
     <th>Original Signal Strength</th>
  ...
  <%
    ...
    String sql="select * from signal_complaint";
    ...
    while(rs.next())
     ...
     %>
    	<tr>
        <td scope="row"><%=rs.getString("cname") %></td>
        <td data-title="Released"><%=rs.getString("location") %></td>
        <td data-title="Studio"><%=rs.getString("signal_strength") %>MBPS</td>
        <td data-title="Studio"><%=rs.getString("original_signal") %></td>
        <td data-title="Studio"><%=rs.getString("solution") %></td>
        <td data-title="Studio"><a href="customer_determine.jsp?loc1=<%=rs.getString("location")%>&&unid=<%=rs.getString("id")%>" style="text-decoration:underline;">Determine Signal Strength</a></td>
