...
#customers th {
  ...
  <body>
  	<div class="wrap">
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="index.html">Service<span>Provider</span></a>
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	        <span class="fa fa-bars"></span> Menu
	      </button>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item "><a href="sprovider_home.jsp" class="nav-link">Upload Plan</a></li>
	        	<li class="nav-item active"><a href="determine_signal.jsp" class="nav-link">Determine Signal Strength</a></li>
	        	<li class="nav-item"><a href="sviewgraph.jsp" class="nav-link">View Graph</a></li>
	        	<li class="nav-item"><a href="view_solution.jsp" class="nav-link">View Solution</a></li>
  ...
  <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb">
		...
		<div class="container">
			<h3 style="font-size:45px;text-align:center;">Determine Signal Strength</h3> <br>
  ...
  <%
    ...
    String sql="select * from signal_complaint where provider_status='"+pstatus+"'";
    ...
    while(rs.next())
     ...
     %>
        ...
        <td data-title="Studio"><%=rs.getString("signal_strength") %>MBPS</td>
         <td data-title="Studio"><%=rs.getString("count1") %>&nbsp;&nbsp;times</td>
        <td data-title="Studio"><a href="request_sendtoadmin.jsp?id=<%=rs.getString("id")%>">Send To Admin</a></td>
