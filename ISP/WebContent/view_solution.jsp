	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item "><a href="determine_signal.jsp" class="nav-link">Determine Signal Strength</a></li>
	        	<li class="nav-item"><a href="sviewgraph.jsp" class="nav-link">View Graph</a></li>
	        	<li class="nav-item active"><a href="view_solution.jsp" class="nav-link">View Solution</a></li>
