...
#customers th {
  ...
  <body>
  	<div class="wrap">
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="index.html"><span>admin</span></a>
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	        <span class="fa fa-bars"></span> Menu
	      </button>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item active"><a href="adminhome.jsp" class="nav-link">Upload Signal Strength</a></li>
	        	<li class="nav-item"><a href="predict_network.jsp" class="nav-link">Predict Range of Network</a></li>
    		...
    		<div class="row d-md-flex justify-content-center">
    			<div class="col-md-12">
	    			<div class="wrap-appointment bg-white d-md-flex pl-md-4 pb-5 pb-md-0">
	    				<form action="upload_signalstrength.jsp" class="appointment w-100">
	    					<div class="row justify-content-center">
				              ...
				              <input type="text" class="form-control" placeholder="Location Name" name="location">
				            </div>
									</div>
									<div class="col-12 col-md d-flex align-items-center">
										<div class="form-group py-md-4 py-2 px-4 px-md-0">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="" target="_blank">ADMIN</a>
