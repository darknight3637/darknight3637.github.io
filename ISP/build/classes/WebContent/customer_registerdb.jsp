...
try
{
	...
	String sql1="select * from customer_register where uname='"+d+"'";
	rs2=st2.executeQuery(sql1);
	if(rs2.next()){
		%>
		 <script>
		  alert("Username already exist");
		  window.location="customer_register.jsp";
		  </script>
		  <% 
	}
	else
	...
	String sql="insert into customer_register(fullname,email,mobile,location,uname,password) values(?,?,?,?,?,?)";
