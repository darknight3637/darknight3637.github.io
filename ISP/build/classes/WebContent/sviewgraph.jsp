...
<html lang="en">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item "><a href="index.html" class="nav-link">Upload Plan</a></li>
	        	<li class="nav-item"><a href="determine_signal.jsp" class="nav-link">Determine Signal Strength</a></li>
	        	<li class="nav-item active"><a href="services.html" class="nav-link">View Graph</a></li>
  ...
  <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb">
		...
		<div class="container">
			<h3 style="font-size:45px;text-align:center;">View Signal Strength</h3> <br>
...
try{
	...
	String qry2 ="select * from signal_strength"; 
	rs2 = st2.executeQuery(qry2);
	while(rs2.next())
	{
		
		trust= rs2.getString("location");
		System.out.println("PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP:"+trust);
		String strenth=rs2.getString("signal_strength");
		count=Integer.parseInt(strenth);
		System.out.println("count:"+count);
		chart as=new chart();
		as.setcloudserver(trust);
		as.setCount(count);
		list.add(as);
	} 
for(Integer i =0;i<list.size(); i++){
		...
		chart a = list.get(i);
		s=s+"{label: \""+a.getlocation()+"\",y:"+a.getCount()+"},";
