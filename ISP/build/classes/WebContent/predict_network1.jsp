...
#customers th {
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item "><a href="adminhome.jsp" class="nav-link">Upload Signal Strength</a></li>
	        	<li class="nav-item active"><a href="predict_network.jsp" class="nav-link">Predict Range of Network</a></li>
 	        	<li class="nav-item"><a href="sviewgraph.jsp" class="nav-link">View Graph</a></li>
	        	<!--<li class="nav-item"><a href="view_solution.jsp" class="nav-link">Customer Solution</a></li>
  ...
  <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb">
		...
		<div class="container">
			<h2 style="color:white;margin-left:370px;font-size:60px;">Internet service provider</h2> <br>
			<div class="contact-w3lsrow">
				...
				<div class="col-md-6 contact-right" style="margin-top:50px;">
						<h1>Location : <font color="red"><%=location %></font></h1><br><br>
						 <%
    ...
    String sql="select * from signal_strength where location='"+location+"'";
    ...
    while(rs.next())
     ...
     %>
    	<h1>The Signal Strength is <font color="green"><%=rs.getString("signal_strength") %></font></h1><br><br>
						
			<a href="adminsolution_toisp.jsp?unid=<%=unid1%>&&loc2=<%=location%>&&osignal=<%=rs.getString("signal_strength")%>" style="font-size:30px;font-weight:bold;text-decoration:underline;">Send The Solution TO ISP</a>			
    				 <%
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="" target="_blank">ServiceProvider</a>
