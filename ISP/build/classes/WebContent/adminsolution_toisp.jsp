...
session.setAttribute("unid1", unid1);
String location=request.getParameter("loc2");
String osignal=request.getParameter("osignal");
...
#customers th {
  ...
  <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb">
		...
		<div class="container">
			<h3 style="font-size:45px;text-align:center;">Prediction Of Signal Strength</h3> <br>
			<div class="contact-w3lsrow">
				...
				<div class="col-md-6 contact-right" style="margin-top:50px;">
						<form action="adminsolution_update.jsp" method="post">
						
						<input type="text" name="location" value="<%=location%>" readonly>
						<input type="text" name="osignal_strength" value="<%=osignal%>" readonly>
						<input type="text" name="customer_email" value="<%=email%>" readonly>
