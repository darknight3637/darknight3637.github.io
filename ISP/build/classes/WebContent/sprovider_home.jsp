	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item active"><a href="sprovider_home.jsp" class="nav-link">Upload Plan</a></li>
    		...
    		<div class="row d-md-flex justify-content-center">
    			<div class="col-md-12">
	    			<div class="wrap-appointment bg-white d-md-flex pl-md-4 pb-5 pb-md-0">
	    				<form action="uploadplandb.jsp" class="appointment w-100">
	    					<div class="row justify-content-center">
				              ...
				              <input type="text" class="form-control" placeholder="Plan Name" name="planname">
				            </div>
									</div>
									<div class="col-12 col-md d-flex align-items-center">
										<div class="form-group py-md-4 py-2 px-4 px-md-0">
											<label for="name">Signal Strength(Mbps)</label>
				              <input type="text"  name="signal_strenght" class="form-control" placeholder="Signal Strength">
				            </div>
									</div>
									<div class="col-12 col-md d-flex align-items-center">
										<div class="form-group py-md-4 py-2 px-4 px-md-0">
				              ...
				              <input type="submit" value="Upload" class="btn btn-primary py-3 px-4">
				            </div>
									</div>
	    					</div>
		          </form>
