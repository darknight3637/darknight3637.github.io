...
<!-- 	        	<li class="nav-item"><a href="sviewgraph.jsp" class="nav-link">View Graph</a></li>
  ...
  <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb">
		...
		<div class="container">
			<h3 style="font-size:45px;text-align:center;">Recommend Network Location</h3> <br>
			<div class="contact-w3lsrow">
				<div class="col-md-6 contact-left wthree">
					<img src="images/wifi.jpg" style="width:300px;height:300px;margin-left:70px;">
				</div>
				<div class="col-md-6 contact-right" style="margin-top:50px;">
					<form action="recommendeddb.jsp" method="post">
         ...
         PreparedStatement ps=con.prepareStatement("select *  from signal_strength where location!='"+c+"' group by location");
