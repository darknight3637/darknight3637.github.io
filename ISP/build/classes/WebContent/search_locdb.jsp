		...
		<div class="container">
			...
			<div class="contact-w3lsrow">
				...
				<div class="col-md-6 contact-right" style="margin-top:50px;">
						...
						<h1>The Signal Strength is <font color="green"><%=cc %></font></h1><br><br>
						<%
						int signal=Integer.parseInt(cc);
						if(signal<=40) 
						{%>
							<a href="problemto_provider1.jsp?cid1=<%=cid%>&&cname=<%=cname%>&&loc1=<%=location%>&&strength=<%=cc%>&&cemail=<%=email1%>" disabled="true">Send The Signal Problem To Service Provider</a>
						<% }
						else
						{
							%>
							<h1>The Signal Is Good</h1>
							<%
						}
